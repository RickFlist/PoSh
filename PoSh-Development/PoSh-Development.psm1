...
function Get-PsModuleFileList
{
    ...
    PROCESS
    {
        Write-Debug ("PROCESS:Entering: [Get-ModuleFileLiist]")
...
function New-PsModuleManifest
{
    ...
    (    
        ...
        [String] $Path = ("{0}.psd1" -f (Split-Path $Pwd.ProviderPath -Leaf))
        ,
        [Parameter()]
        [ValidateNotNullOrEmpty()]
        ...
        [System.Version] $ModuleVersion = (New-VersionNumber)
        ,
        [Parameter()]
